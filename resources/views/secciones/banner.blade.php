<div class="container">
    ...
    <h2 style="text-align:center;font-family:Sacramento;color:black;">Escoge tu leunguaje favorito y comienza a
        programar, Suerte:)</h2>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="widget subscribe no-box" style="background: rgb(163, 228, 215);border-radius: 20px">
                        <br>
                        <h1 class="card-title"
                            style="text-align:center;font-family:Sulphur Point;color:rgb(0, 0, 128);">
                            <?=$lenguaje['nombre']?><span></span></h1>
                        <p style="text-align:center;font-family:Sulphur Point;color:rgb(0, 0, 128)">
                            <?=$lenguaje['descripcion']?></p>
